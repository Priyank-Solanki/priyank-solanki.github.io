...
export function SkillsSection() {
  ...
  const additionalSkills = [
    'Flutter', 'React Native', 'Git', 'GraphQL', 'REST APIs', 
  ...
  return (
    <section id="skills" className="py-20 lg:py-32 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900/20 dark:via-blue-950/10 dark:to-purple-950/10 relative overflow-hidden">
                  ...
                  {category.skills.map((skill, skillIndex) => (
                    ...
                    >
                      ...
                      <div className="relative">
                        <Progress 
                          value={animatedValues[`${categoryIndex}-${skillIndex}`] || 0} 
                          className="h-2"
                        />
                        <div 
          ...
          <Card className="border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="relative z-10">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div 
                    className="w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-xl flex items-center justify-center hover:scale-110 transition-transform duration-300"
                  >
                    <Layers className="w-6 h-6 text-gray-600 dark:text-gray-400" />
                  </div>
                  <CardTitle className="text-xl text-gray-900 dark:text-white">Additional Technologies & Tools</CardTitle>
                </div>
              </CardHeader>
