...
export function AboutSection() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: 'React.js, Next.js, NestJS, PostgreSQL, AWS',
  ...
  const stats = [
    ...
    { number: '15+', label: 'Technologies Mastered', icon: Globe },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10" ref={ref}>
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Passionate Full Stack Software Engineer & Technical Lead with expertise in building innovative web and mobile applications
          </motion.p>
        </motion.div>
          ...
          <motion.div className="space-y-8" variants={itemVariants}>
            <div className="space-y-6">
              <motion.p 
                ...
                variants={itemVariants}
              >
                I'm a dedicated Full Stack Software Engineer and Technical Lead with over{' '}
                <span className="font-semibold text-blue-600 dark:text-blue-400">6 years of experience</span>{' '}
                in developing cutting-edge web and mobile applications. My journey in software development has been 
                driven by a passion for creating efficient, scalable solutions that make a real impact.
              </motion.p>
              ...
              >
                ...
                from startups to established companies. I specialize in modern JavaScript frameworks, backend 
                development, and cloud technologies, with a strong focus on delivering high-quality, 
              ...
              >
                ...
                to open-source projects, and mentoring fellow developers in their journey.
              </motion.p>
            </div>
            ...
            <motion.div 
              ...
              variants={itemVariants}
            >
              {['React.js', 'Next.js', 'NestJS', 'PostgreSQL', 'AWS', 'CI/CD'].map((tech, index) => (
                <motion.div
                  key={tech}
            ...
            {highlights.map((highlight, index) => (
              ...
              >
                <Card className="relative overflow-hidden border-0 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm">
                    ...
                    <div className="flex items-start space-x-4">
                      <div className="flex-shrink-0">
                        ...
                        >
                          ...
                          <div className={`absolute inset-0 bg-gradient-to-br ${highlight.color} opacity-20`}></div>
                        </motion.div>
                      </div>
                      <div className="flex-1">
                        <h3 className="font-semibold mb-2 text-gray-900 dark:text-white">{highlight.title}</h3>
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-r ${highlight.color} opacity-0 hover:opacity-10 transition-opacity duration-300 pointer-events-none`}></div>
                </Card>
              </motion.div>
            ))}
          </motion.div>
