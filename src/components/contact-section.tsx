...
import { Mail, Phone, Linkedin, Github, MapPin, Send, CheckCircle, Zap } from 'lucide-react';
...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 lg:py-32 bg-gradient-to-br from-gray-50 via-blue-50/20 to-purple-50/20 dark:from-gray-900/20 dark:via-blue-950/5 dark:to-purple-950/5 relative overflow-hidden">
        ...
        >
          ...
          <motion.div className="space-y-6" variants={itemVariants}>
            <div className="group relative overflow-hidden rounded-xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500">
              ...
              <div className="p-6 pb-4">
                <h3 className="text-2xl lg:text-3xl font-semibold text-gray-900 dark:text-white">Contact Information</h3>
              </div>
            ...
            <div className="group relative overflow-hidden rounded-xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500">
              ...
              <div className="px-6 pb-6">
                <div className="space-y-4">
                  {[
                    { status: 'Available for freelance projects', color: 'bg-green-500' },
                    { status: 'Open to full-time opportunities', color: 'bg-green-500' },
                    { status: 'Response time: Within 24 hours', color: 'bg-yellow-500' }
                  ].map((item, index) => (
                    <motion.div 
                      key={index}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm text-blue-800 dark:text-blue-200">
                        <strong>Preferred Communication:</strong> Email for detailed discussions, 
                        LinkedIn for professional networking, and phone calls for urgent matters.
                      </p>
                    </div>
                  </div>
                </motion.div>
