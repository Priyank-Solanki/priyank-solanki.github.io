        ...
        >
          ...
          <motion.div className="lg:col-span-2" variants={itemVariants}>
            ...
            <p className="text-muted-foreground mb-6 max-w-md leading-relaxed text-base">
              Full Stack Software Engineer & Technical Lead passionate about
              building innovative, scalable solutions that make a difference.
          ...
          <motion.div variants={itemVariants}>
            <h4 className="font-semibold mb-6 text-gray-900 dark:text-white text-lg">
              Contact Info
            </h4>
        ...
        >
          ...
          >
            <div className="flex items-center space-x-2 text-muted-foreground">
              <span>© {new Date().getFullYear()} Priyank Solanki. All rights reserved.</span>
            </div>
